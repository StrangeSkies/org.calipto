...
import org.strum.type.StrumTypes;
...
@NodeInfo(language = "Strum", description = "The abstract base node for all expressions")
@GenerateWrapper
@ReportPolymorphism
public abstract class StrumNode extends Node implements InstrumentableNode {
  ...
  public WrapperNode createWrapper(ProbeNode probe) {
    return new StrumNodeWrapper(this, probe);
  }

...
public final class PresteLexicalScope {
   ...
   */
  private PresteLexicalScope(Node current, SLBlockNode block, SLBlockNode parentBlock) {
   ...
   */
  private PresteLexicalScope(Node current, SLBlockNode block, RootNode root) {
    this.current = current;
    this.block = block;
  ...
  public static PresteLexicalScope createScope(Node node) {
    ...
    if (block == null) {
      ...
      if (block == null) {
        ...
        return new PresteLexicalScope(null, null, (SLBlockNode) null);
      }
    ...
    if (parentBlock == null) {
      return new PresteLexicalScope(node, block, block.getRootNode());
    } else {
      return new PresteLexicalScope(node, block, parentBlock);
    }
  }
  ...
  public PresteLexicalScope findParent() {
    if (parentBlock == null) {
    ...
    if (parent == null) {
      ...
      if (newParentBlock == null) {
        parent = new PresteLexicalScope(node, newBlock, newBlock.getRootNode());
      } else {
        parent = new PresteLexicalScope(node, newBlock, newParentBlock);
      }
    }
    return parent;
  }

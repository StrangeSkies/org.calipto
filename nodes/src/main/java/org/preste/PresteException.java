...
public class PresteException extends RuntimeException implements TruffleException {
  private static final long serialVersionUID = 1L;

  private final Node location;

  @TruffleBoundary
  public PresteException(Node location, String message) {
    super(decorateMessage(location, message));
    this.location = location;
  }

  @TruffleBoundary
  public PresteException(Node location, String message, Throwable cause) {

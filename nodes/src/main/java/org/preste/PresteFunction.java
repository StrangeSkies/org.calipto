...
/**
 * Represents a Preste function. In the language a function is just a value of a
...
public final class PresteFunction implements TruffleObject {
  ...
  /**
   * {@link PresteFunction} instances are always visible as executable to other
   * languages.
   */

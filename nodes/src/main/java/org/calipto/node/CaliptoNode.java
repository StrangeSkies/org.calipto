...
import org.calipto.type.CaliptoTypes;
...
@TypeSystemReference(CaliptoTypes.class)
@NodeInfo(language = "Calipto", description = "The abstract base node for all expressions")
@GenerateWrapper
@ReportPolymorphism
public abstract class CaliptoNode extends Node implements InstrumentableNode {
  ...
  public WrapperNode createWrapper(ProbeNode probe) {
    return new CaliptoNodeWrapper(this, probe);
  }

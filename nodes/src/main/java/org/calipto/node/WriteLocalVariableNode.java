...
public abstract class WriteLocalVariableNode extends CaliptoNode {
   ...
   * was never written before, therefore a Truffle DSL
   * {@link #isLongOrIllegal(VirtualFrame) custom guard} is specified.
   */
   ...
   *
   * @param frame
   *          The parameter seems unnecessary, but it is required: Without the
   ...
   *          assumed to be pure, but our guard depends on the slot kind which can
   *          change.
   */

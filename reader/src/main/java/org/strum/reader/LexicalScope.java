...
public class LexicalScope {
  ...
  private Map<StrumData, ReaderMacro> namedMacros;
  ...
  public Optional<ReaderMacro> findMacro(StrumData symbol) {
    if (namedMacros != null) {
  ...
  public void setMacro(StrumData symbol, ReaderMacro macro) {
    if (namedMacros == null) {

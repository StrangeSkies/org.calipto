...
public class LexicalScope {
  ...
  private Map<PresteData, ReaderMacro> namedMacros;
  ...
  public Optional<ReaderMacro> findMacro(PresteData symbol) {
    if (namedMacros != null) {
  ...
  public void setMacro(PresteData symbol, ReaderMacro macro) {
    if (namedMacros == null) {
